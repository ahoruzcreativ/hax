function (qc) {
    ...
    function P (a) {
        ...
        Ka.Yo().then(function (d) {
            null == P.vg && (P.vg = window.document.createElement("div"),
            ...
            if (!(1 > b.length)) {
                ...
                c.onload = function () {
                    try {
                        ...
                        b = l instanceof p ? l.Ta : l,
                            b instanceof SyntaxError ? y.i(a.di, "SyntaxError in line: " + K.xe(b.lineNumber)) : b instanceof Bb ? y.i(a.di, b.pp) : y.i(a.di, "Error loading stadium file.")
                    }
                }
                    ;
                c.readAsText(b)
    ...
    function Tb () {
        this.xc = 0;
        this.Za = [];
        this.vr = new R(["Time is", "Up!"], 16777215);
        this.Bq = new R(["Red is", "Victorious!"], 15035990);
        this.Aq = new R(["Red", "Scores!"], 15035990);
        this.vn = new R(["Blue is", "Victorious!"], 625603);
        this.un = new R(["Blue", "Scores!"], 625603);
        this.Wp = new R(["Game", "Paused"], 16777215)
    }
    function R (a, b) {
    ...
    function Vb (a) {
        ...
        this.jo = Promise.all([b("sounds/chat.ogg").then(function (a) {
            return c.Nj = a
    ...
    function Jb (a, b, c) {
        ...
        this.si();
        this.Uh = window.performance.now();
        this.uc = -1
    }
    function Kb (a) {
        this.Hd = a
    ...
    function Ob (a) {
        ...
        var c = null
            , c = function () {
                var a = b.zq - b.wr();
                0 >= a ? b.ia() : (window.clearTimeout(b.rm),
        ...
        for (var d = this.Tc; a < d.length;) {
            ...
            e.onmessage = function (a) {
                b.wd && (b.pm = window.performance.now(),
                    null != b.jg && b.jg(a.data))
            }
                ;
            e.onclose = function () {
                b.ia()
    ...
    function Va (a, b, c) {
        ...
        this.Qa.onicecandidate = function (a) {
            null == a.candidate ? d.No(d.Sf) : (a = a.candidate,
                null != a.candidate && "" != a.candidate && (null != d.hg && d.hg(a),
                    d.Sf.push(a)))
        }
            ;
        for (b = 0; b < c.length;)
    ...
    var Pb = Ab["bas.basnet.FailReason"] = {
        Ef: !0,
        kh: ["PeerFailed", "Rejected", "Cancelled", "Error"],
        $m: {
            wb: 0,
    ...
    xb.prototype = {
        ...
        Qj: function () {
            null != this.fa && (this.fa.onclose = null,
                this.fa.onmessage = null,
                this.fa.onerror = null,
                this.fa.onopen = null,
                this.fa.close(),
                this.fa = null);
            null != this.pa && (this.pa.ia(),
                this.pa = null)
        },
        Ne: function (a) {
    ...
    Va.prototype = {
        ...
        Xn: function () {
            this.Zj(this.Qa.createOffer(), [], 1E3)
        },
        Zj: function (a, b, c) {
            var d = this;
            a.then(function (a) {
    ...
    Sa.prototype = {
        ...
        Ci: function (a) {
            ...
            if (null != this.Lc || null != a) {
                ...
                this.Lc = a.slice(0);
                this.yg = !0;
                null != this.fa && 1 == this.fa.readyState && null == this.ie && (this.yi(),
                    this.ie = window.setTimeout(function () {
                        b.ie = null;
    ...
    F.ao = function (a, b) {
        ...
        if (0 == (c & 128))
            ...
            d = a.getUint8(b + 1),
                ...
                g = a.getUint8(b + 4),
                l = a.getUint8(b + 5),
                c = (c & 1) << 30 | (d & 63) << 24 | (e & 63) << 18 | (f & 63) << 12 | (g & 63) << 6 | l & 63,
                b += 6;
        else
    ...
    F.prototype = {
        ...
        zb: function () {
            for (var a = this.a, b = 0, c, d = 0; c = this.o.getUint8(a + b),
                5 > b && (d |= (c & 127) << 7 * b >>> 0),
                ++b,
                0 != (c & 128);)
                ;
    ...
    w.prototype = {
        ...
        Cb: function (a) {
            null == a ? this.kb(0) : (this.kb(w.Jf(a) + 1),
                this.Mg(a))
        },
        zm: function (a) {
            var b = w.Jf(a);
        ...
        kb: function (a) {
            ...
            128 <= a ? (this.o.setUint8(b + 1, a >> 7 | 128),
                16384 <= a ? (this.o.setUint8(b + 2, a >> 14 | 128),
                    2097152 <= a ? (this.o.setUint8(b + 3, a >> 21 | 128),
                        268435456 <= a ? (this.o.setUint8(b + 4, a >> 28 & 127),
                            a = 5) : (this.o.setUint8(b + 3, this.o.getUint8(b + 3) & 127),
                                a = 4)) : (this.o.setUint8(b + 2, this.o.getUint8(b + 2) & 127),
                                    a = 3)) : (this.o.setUint8(b + 1, this.o.getUint8(b + 1) & 127),
                                        a = 2)) : (this.o.setUint8(b, this.o.getUint8(b) & 127),
                                            a = 1);
            this.a += a
        },
        f: w
    ...
    I.qo = function () {
        try {
            return window.crypto.subtle.generateKey(I.nh, !0, ["sign", "verify"]).then(function (a) {
                var b = a.privateKey;
    ...
    m.dh = function (a) {
        var b = a.B()
            , b = Object.create(m.Hm.get(b).prototype);
        b.ba = 0;
        b.lb = 0;
        b.va(a);
        return b
    ...
    Mb.prototype = {
        add: function (a) {
            ...
            b >= this.ms ? (b = this.Ya[c],
                this.Pd -= b.weight,
                this.Ya.splice(c, 1)) : b = new cc;
            b.value = a;
            b.weight = 1;
            b.index = 0;
            this.Pd += b.weight;
    ...
    bc.prototype = {
        stop: function () {
            ...
            var a = pako.deflateRaw(this.Md.Sb())
                , b = w.ga(a.byteLength + 32);
            b.Mg("HBR2");
            b.sb(this.version);
    ...
    V.prototype = C(yb.prototype, {
        ...
        Ag: function (a) {
            a.lb == this.X && a.ba <= this.cc ? (a.ba = this.cc++ ,
                a.apply(this.T),
                null != this.fc && this.fc(a)) : this.je.Im(a)
        },
        sk: function (a, b) {
            if (0 >= a)
                return this.T;
    ...
    xa.prototype = C(V.prototype, {
        ia: function (a) {
            null != this.pc && (this.pc.ad = null,
                this.pc.zn(),
                this.pc = null);
            window.clearTimeout(this.pe);
            null != this.pa && (this.pa.bf = null,
                this.pa.ia(),
                this.pa = null);
        ...
        C: function () {
            ...
            this.Vc = window.performance.now() * this.Ac + this.Ni.Yg(.5) - this.X;
            this.Kj()
        },
        Qf: function () {
            return this.wd() ? (0 > this.bc && (this.bc = 0),
                this.sk(window.performance.now() * this.Ac + this.Ni.Yg(.5) - this.X + this.bc + this.rd, this.sg)) : this.T
        },
        Kj: function () {
            0 > this.Vc && (this.Vc = 0);
    ...
    Lb.prototype = C(V.prototype, {
        ...
        C: function () {
            ...
            this.X - this.Fk >= this.Fn && (this.Ai(),
                this.br())
        },
        Qf: function () {
            0 > this.bc && (this.bc = 0);
    ...
    Jb.prototype = C(V.prototype, {
        ...
        yl: function () {
            var a = this.Kc;
            0 < a.o.byteLength - a.a ? (a = this.Kc.zb(),
                this.fg += a,
                a = this.Kc.Ob(),
                this.eg = m.dh(this.Kc),
                this.eg.P = a) : this.eg = null
        },
        yo: function () {
        ...
        C: function () {
            var a = window.performance.now()
                , b = a - this.Uh;
            this.Uh = a;
            0 < this.Fd ? (this.Qb += 1E4,
                this.Qb > this.Fd && (this.Qb = this.Fd,
                    this.Fd = -1)) : this.Qb += b * this.ll;
            a = this.lf * this.jh;
            this.Qb > a && (this.Qb = a);
            b = this.Qb * this.Ac;
            a = b | 0;
    ...
    ub.prototype = {
        ...
        C: function () {
            var a = window.performance.now()
                , b = Math.floor((a - this.Ue) / this.Pi);
            this.Ue += b * this.Pi;
            this.oc += b;
            this.oc >= this.Jj && (this.oc = this.Jj,
                this.Ue = a)
        },
        f: ub
    };
    ...
    vb.prototype = {
        ff: function (a) {
            ...
            switch (c) {
                case "avatar":
                    2 == a.length && (this.Yl(a[1]),
                        this.ha("Avatar set"));
                    break;
                case "checksum":
                    var d = this.ya.T.S;
                    a = d.w;
                    d.Oe() ? this.ha('Current stadium is original: "' + a + '"') : (d = J.Tg(d.Oj(), 8),
                        this.ha('Stadium: "' + a + '" (checksum: ' + d + ")"));
                    break;
                case "clear_avatar":
                    this.Yl(null);
                    ...
                    break;
                case "clear_bans":
                    null == this.Td ? this.ha("Only the host can clear bans") : (this.Td(),
                        this.ha("All bans have been cleared"));
                    break;
                case "clear_password":
                    null == this.Dg ? this.ha("Only the host can change the password") : (this.Dg(null),
                        this.ha("Password cleared"));
                    break;
                case "colors":
                    try {
                        d = vb.Vp(a),
                        ...
                        a = f instanceof p ? f.Ta : f,
                            "string" == typeof a && this.ha(a)
                    }
                    break;
                case "extrapolation":
                    2 == a.length ? (a = K.parseInt(a[1]),
                        null != a && -200 <= a && 200 >= a ? (n.A.rd.Wa(a),
                            this.ya.Zl(a),
                            this.ha("Extrapolation set to " + a + " msec")) : this.ha("Extrapolation must be a value between -200 and 50 milliseconds")) : this.ha("Extrapolation requires a value in milliseconds.");
                    break;
                case "loadmod":
                    var d = window.document.createElement("input");
                    d.type = "file";
                    d.accept = ".json,.json5,.wlsprt";
                    d.multiple = !0;
                    d.click();
                    d.onchange = function () {
                        var a = d.files;
                        if (!(1 > a.length)) {
                            for (var c = null, g = null, h = 0; h < a.length;) {
                                var k = a[h];
                                ++h;
                                var l = ""
                                    , n = k.name.lastIndexOf(".");
                                -1 != n && (l = A.substr(k.name, n + 1, null).toLowerCase());
                                switch (l) {
                                    case "json":
                                    case "json5":
                                        c = k;
                            ...
                            if (null != g) {
                                ...
                                p.onload = function () {
                                    v = sc.read(new z(new DataView(p.result), !0));
                                    H()
                                }
                                    ;
                                p.readAsArrayBuffer(g)
                            } else
                                v = {
                                    ba: a.ba,
                                    yl: a.Gb
                ...
                case "handicap":
                    2 == a.length ? (a = K.parseInt(a[1]),
                        null != a && 0 <= a && 300 >= a ? (this.ya.fr(a),
                            this.ha("Ping handicap set to " + a + " msec")) : this.ha("Ping handicap must be a value between 0 and 300 milliseconds")) : this.ha("Ping handicap requires a value in milliseconds.");
                    break;
                case "kick_ratelimit":
                    4 > a.length ? this.ha("Usage: /kick_ratelimit <min> <rate> <burst>") : (d = K.parseInt(a[1]),
                        c = K.parseInt(a[2]),
                        a = K.parseInt(a[3]),
                        null == d || null == c || null == a ? this.ha("Invalid arguments") : this.ya.ra(ma.la(d, c, a)));
                    break;
                case "set_password":
                    2 == a.length && (null == this.Dg ? this.ha("Only the host can change the password") : (this.Dg(a[1]),
                        this.ha("Password set")));
                    break;
                case "store":
                    var e = this.ya.T.S;
        ...
        Yl: function (a) {
            null != a && (a = U.Pc(a, 2)); // get the avatar to len <= 2
            debugger;
            n.A.ph.Wa(a); // localStorage update
            this.ya.ra(ra.la(a)) // server ??
        },
        f: vb
    };
    Ia.b = !0;
    ...
    ca.uq = function (a) {
        ...
        0 != f && (b = function () {
            ...
            ,
            e == d ? 2 > f || (a.ra(S.la(b(), q.da)),
                a.ra(S.la(b(), q.xa))) : (d = e > d ? q.da : q.xa,
                    a.ra(S.la(b(), d))))
    }
        ;
    ca.prototype = {
        ...
        Jc: function () {
            var a = window.performance.now();
            1 == n.A.Dh.L() && 28.333333333333336 > a - this.Yc || (this.Yc = a,
                this.sd++ ,
                this.sf(),
        ...
        Wl: function (a) {
            a != this.Ek && (this.ya.ra(na.la(a ? 0 : 1)),
                this.Ek = a)
        },
        sm: function () {
            if (null != this.ya.T.K) {
    ...
    Gb.prototype = {
        ...
        oi: function (a) {
            ...
            a.ql = function (d, e, f, g) {
                y.i(c.Gp, d.V);
                null == e ? d = "" + d.w + " has left" : (wb.i(c.Fp, d.V, e, null != g ? g.w : null, f),
    ...
    T.Pf = function (a) {
        ...
        ;
    T.xo = function () {
        return N.pk(n.Gf + "api/geo").then(function (a) {
            return T.Pf(a)
        })
    }
        ;
    ...
    v.fo = function () {
        ...
        b.Bp = function (b) {
            ...
            k.Wk = function (a) {
                null != g.na(a) && (a = Z.la(a, "Bad actor", !1),
                    k.ra(a))
            }
                ;
            k.zp = function (a, b) {
    ...
    v.ho = function (a) {
        try {
            ...
            if (c instanceof Kb)
                a = new W("Incompatible replay version", "The replay file is of a different version", ["Open player", "Cancel"]),
                    x.Sa(a.g),
                    a.$a = function (a) {
                        0 == a ? (a = window.top.location,
                            window.top.open(a.protocol + "//" + a.hostname + (null != a.port ? ":" + a.port : "") + "/replay?v=" + c.Hd, "_self")) : v.Mb()
                    }
                    ;
            else {
    ...
    v.Nf = function (a, b) {
        try {
            ...
            window.console.log(Q instanceof p ? Q.Ta : Q),
                c = new W("Unexpected Error", "", []),
                c.He.innerHTML = "An error ocurred while attempting to join the room.<br><br>This might be caused by a browser extension, try disabling all extensions and refreshing the site.<br><br>The error has been printed to the inspector console.",
                x.Sa(c.g)
        }
    }
        ;
    ...
    x.cj = function (a) {
        x.es() && x.$r(function () {
            ...
            return Promise.all([N.L("res.dat", "arraybuffer").then(function (a) {
                a = new JSZip(a);
                n.Ma = new Vb(a);
                return Promise.all([n.Ma.jo, x.Ug(a.file("images/grass.png").asArrayBuffer()).then(function (a) {
                    return n.Co = a
    ...
    va.Cs = function (a, b) {
        for (var c = a.Ec, d = a.Gc, e = 0; e < b.length;) {
            ...
            ++e;
            var g = f.vd;
            f.Ke = 6378 * va.ds(.017453292519943295 * g.Ec, .017453292519943295 * g.Gc, .017453292519943295 * c, .017453292519943295 * d);
            isFinite(f.Ke) || (f.Ke = 22E3)
        }
    }
        ;
    va.get = function () {
    ...
    Ub.prototype = {
        update: function () {
            ...
            0 >= this.ah && .05 > this.ue && (window.clearInterval(this.eh),
                this.eh = null,
                this.ue = 0);
        ...
        nj: function (a) {
            ...
            null == this.eh && (this.eh = window.setInterval(function () {
                ...
                this.Lm = window.performance.now())
        },
        connect: function (a) {
            this.Rg.connect(a)
        },
        Gs: function (a) {
            ...
            if (null != b)
                if (2 == b.Ab)
                    ...
                    null != k && null != e && 0 >= b.Na && (f.a.x > k.a.x && c.a.x > k.a.x && 20 < c.a.x && this.nj(.3),
                        t.a.x < e.a.x && c.a.x < e.a.x && -20 > c.a.x && this.nj(.3))
                }
        },
        f: Ub
    };
    ...
    O.prototype = {
        ...
        yk: function (a) {
            if (a.ca == q.Ia)
                ...
                0 == d.length ? (b.a.x = a.ca.Ah * this.S.$b,
                    b.a.y = 0) : (a = b.a,
                        d = d[d.length - 1],
                        a.x = d.x,
                        a.y = d.y);
        ...
        sc: function () {
            var a = ya.zc
                , b = this.gc;
            this.hc != a && (null == b && (this.gc = b = new O),
                this.hc = a,
                O.qd(b, this));
            return b
        },
    ...
    h.To = function (a) {
        var b = {
            d0: a.Wd,
            d1: a.Xd,
            length: a.Gb >= a.ec ? a.Gb : [a.Gb, a.ec]
        };
        h.og(b, a.R, 0);
    ...
    h.ap = function (a, b) {
        ...
        null == l ? (d = b[d],
            l = b[e],
            null == d || null == l ? c.ec = c.Gb = 100 : (e = d.a,
                l = l.a,
                d = e.x - l.x,
                e = e.y - l.y,
                c.ec = c.Gb = Math.sqrt(d * d + e * e))) : l instanceof Array && null == l.mb ? (c.Gb = r.G(l[0], z),
                    c.ec = r.G(l[1], z)) : c.ec = c.Gb = r.G(l, z);
    ...
    h.aq = function (a) {
        ...
        h.ka(b, "acceleration", a.Be, .1);
        h.ka(b, "kickingAcceleration", a.Se, .07);
        h.ka(b, "kickingDamping", a.Te, .96);
    ...
    h.prototype = {
        ...
        Hk: function (a) {
            ...
            var g = e.traits;
            a = e.ballPhysics;
            "disc0" != a && (null != a ? (a = h.Ik(a, this.ag()),
                a.v |= 192,
                this.F.push(a)) : this.F.push(this.ag()));
    ...
    ga.prototype = {
        ...
        Lf: function (a, b, c) {
            if (b.ca != c) {
                ...
                this.I.push(b);
                if (null != this.K) {
                    null != b.H && (D.remove(this.K.ta.F, b.H),
                        b.H = null);
                    this.K.yk(b);
                    for (var d = 0, e = !1; !e;) {
                        ++d;
        ...
        sc: function () {
            var a = ya.zc
                , b = this.gc;
            this.hc != a && (null == b && (this.gc = b = new ga),
                this.hc = a,
                ga.qd(b, this));
            return b
        },
    ...
    fa.prototype = {
        ...
        cs: function () {
            var a = ya.zc
                , b = this.Sm;
            this.zc != a && (null == b && (this.Sm = b = new fa),
                this.zc = a,
                fa.Vr(b, this));
            return b
        },
    ...
    ta.prototype = C(m.prototype, {
        apply: function (a) {
            var b = a.na(this.P);
            null != b && this.Wg != b.Kd && (b.Kd = this.Wg,
                y.i(a.ol, b))
        },
        ua: function (a) {
            a.l(this.Wg ? 1 : 0)
    ...
    Qa.prototype = C(m.prototype, {
        apply: function (a) {
            if (a.Kb(this.P, 1)) {
                ...
                c = d.length;
                0 != c && (f == e ? 2 > c || (a.Lf(b, d[0], q.da),
                    a.Lf(b, d[1], q.xa)) : a.Lf(b, d[0], f > e ? q.da : q.xa))
            }
        },
        ua: function () { },
        va: function () { },
    ...
    sa.prototype = C(m.prototype, {
        apply: function (a) {
            if (a.Kb(this.P, 4)) {
                var b = a.na(this.P)
                    , c = a.na(this.Ld);
                null != c && 0 != c.V && c.bb != this.Vg && (c.bb = this.Vg,
                    null != a.gi && a.gi(b, c))
            }
        },
        ua: function (a) {
    ...
    qa.prototype = C(m.prototype, {
        apply: function (a) {
            if (a.Kb(this.P, 8)) {
                var b = a.na(this.P);
                null == a.K && (a.S = this.Od,
                    null != a.Fi && a.Fi(b, this.Od))
            }
        },
        ua: function (a) {
            var b = w.ga();
            ...
            if (0 == this.P) {
                ...
                if (null != b) {
                    if (this.Jm) {
                        ...
                        a = b.ta.F[this.ye];
                    null != a && (null != this.La[0] && (a.a.x = this.La[0]),
                        null != this.La[1] && (a.a.y = this.La[1]),
                        null != this.La[2] && (a.D.x = this.La[2]),
                        null != this.La[3] && (a.D.y = this.La[3]),
                        null != this.La[4] && (a.oa.x = this.La[4]),
                        null != this.La[5] && (a.oa.y = this.La[5]),
                        null != this.La[6] && (a.Y = this.La[6]),
                        null != this.La[7] && (a.m = this.La[7]),
                        null != this.La[8] && (a.$ = this.La[8]),
                        null != this.La[9] && (a.Ca = this.La[9]),
                        null != this.ed[0] && (a.R = this.ed[0]),
                        null != this.ed[1] && (a.h = this.ed[1]),
                        null != this.ed[2] && (a.v = this.ed[2]))
                }
            }
        },
        ua: function (a) {
    ...
    da.prototype = {
        ...
        sc: function () {
            var a = ya.zc
                , b = this.gc;
            this.hc != a && (null == b && (this.gc = b = new da),
                this.hc = a,
                da.qd(b, this));
            return b
        },
    ...
    M.prototype = {
        ...
        Kr: function () {
            if (null != this.sa.parentElement) {
                var a = window.devicePixelRatio * this.xg
        ...
        Jc: function (a, b) {
            ...
            if (null != a.K) {
                var c = a.K
                    ...
                    , f = a.na(b)
                    , g = null != f ? f.H : null
                    , l = 0 != this.hf ? this.sa.height / this.hf : this.jf * window.devicePixelRatio * this.xg
                    , k = this.vf * this.xg
                    , h = c.S.Xe
                    , m = this.sa.width / l;
                0 < h && m > h && (m = h,
                ...
                this.c.lineWidth = 2;
                f = 0;
                for (g = a.I; f < g.length;) // draws players
                    m = g[f],
                        ++f,
                        h = m.H,
                        null != h && this.Gl(h, this.cd.get(m.V));
                f = 0;
                for (e = e.F; f < e.length;) // draws other discs
                    g = e[f],
                        ++f,
                        null == this.Hg.get(g) && this.Gl(g, null);
                this.c.lineWidth = 3;
                this.c.resetTransform();
        ...
        Qn: function (a, b, c) {
            a > 2 * c.$b ? this.cb.x = 0 : this.cb.x + .5 * a > c.$b ? this.cb.x = c.$b - .5 * a : this.cb.x - .5 * a < -c.$b && (this.cb.x = -c.$b + .5 * a);
            b > 2 * c.qc ? this.cb.y = 0 : this.cb.y + .5 * b > c.qc ? this.cb.y = c.qc - .5 * b : this.cb.y - .5 * b < -c.qc && (this.cb.y = -c.qc + .5 * b)
        },
        Kq: function (a) {
            this.c.beginPath();
        ...
        Jq: function (a) {
            var b = 0 < a.Na;
            this.gr(b);
            b && (120 != a.Na && (a = a.Na / 120 * 200,
                this.c.fillStyle = "white",
                this.c.fillRect(.5 * -a, 100, a, 20)),
                this.td.Wp.Oq(this.c))
        },
        gr: function (a) {
            this.zk != a && (this.sa.style.filter = a ? "grayscale(70%)" : "",
                this.zk = a)
        },
        ...
        Iq: function (a, b) {
            for (var c = n.A.wk.L(), d = 0, e = a.I; d < e.length;) {
                ...
                if (null != g) {
                    var g = g.a
                        , h = this.cd.get(f.V);
                    c && h.Vf && this.c.drawImage(n.um, g.x - .5 * n.um.width, g.y - 35);
                    h.ko(this.c, g.x, g.y + 50) // RESPONSIBLE FOR NICKNAME
                }
            }
        },
        Gl: function (a, b) { // draws discs
            this.c.beginPath();
            null == b ? (this.c.fillStyle = M.lc(a.R),
                this.c.strokeStyle = "black") : (this.c.fillStyle = b.Ej, // avatar pattern
                    this.c.strokeStyle = b.co);
            this.c.beginPath();
        ...
        jk: function (a, b, c, d) {
            ...
            900 < f * f + a * a && (this.c.fillStyle = "rgba(0,0,0,0.5)",
                this.kk(c + 2, d + 2, Math.atan2(a, f)),
                this.c.fillStyle = M.lc(b),
                this.kk(c - 2, d - 2, Math.atan2(a, f)))
        },
        kk: function (a, b, c) {
            this.c.save();
    ...
    R.prototype = {
        ro: function () {
            return 2.31 + .1155 * (this.Ve.length - 1)
        },
        Jc: function (a, b) {
            var c = b / 2.31
                , d = 0;
            ...
            for (var e = 0, f = this.Ve; e < f.length;) {
                ...
                ++e;
                var h = c - .05 * d
                    , k = 180 * R.bn.eval(h) * (0 != (d & 1) ? -1 : 1);
                a.globalAlpha = R.an.eval(h);
                a.drawImage(g, k - .5 * g.width, 35 * -(this.Ve.length - 1) + 70 * d - .5 * g.height);
                a.globalAlpha = 1;
                ++d
            }
        ...
        Oq: function (a) {
            ...
            for (var c = 0, d = this.Ve; c < d.length;) {
                var e = d[c];
                ++c;
                a.drawImage(e, .5 * -e.width, 35 * -(this.Ve.length - 1) + 70 * b - .5 * e.height);
                ++b
            }
            a.imageSmoothingEnabled = !1
        },
    ...
    Fa.Un = function (a, b) {
        ...
        ;
    Fa.prototype = {
        Yn: function () { // canvas for nickname
            var a = window.document.createElement("canvas");
            a.width = 160;
            a.height = 34;
            this.rl = a.getContext("2d", null)
        },
        Jr: function () { // draw text in nickname canvas
            var a = this.rl;
            a.resetTransform();
            a.clearRect(0, 0, 160, 34);
            a.font = "26px sans-serif";
            a.fillStyle = "white";
            160 < a.measureText(this.w).width ? (a.textAlign = "left",
                a.translate(2, 29)) : (a.textAlign = "center",
                    a.translate(80, 29));
            a.fillText(this.w, 0, 0)
        },
        ko: function (a, b, c) { // draw nickname canvas in global canvas
            a.drawImage(this.rl.canvas, 0, 0, 160, 34, b - 40, c - 34, 80, 17)
        },
        C: function (a, b) {
            if (null != a.H) {
                var c = n.A.om.L() ? b.jb[a.ca.Z] : a.ca.nm
                    , d = null != a.Id ? a.Id : a.Xb
                    , e = n.A.cm.L() && null != d;
                if (!Fa.En(this.jb, c) || !e && a.Ib != this.rh || e && this.If != d)
                    Fa.Un(this.jb, c),
                        e ? (this.If = d,
                            this.rh = -1) : (this.If = "" + a.Ib,
                                this.rh = a.Ib),
                        this.Cq(this.If)
            }
        ...
        Cq: function (a) { // get avatar pattern
            var b = this.jb.eb;
            if (b.length > 0) {
                this.qb.save();
                this.qb.translate(32, 32);
                this.qb.rotate(3.141592653589793 * this.jb.hd / 128);
                for (var c = -32, d = 64 / b.length, e = 0; e < b.length;) // custom color
                    this.qb.fillStyle = M.lc(b[e++]),
    ...
    Ea.prototype = {
        ...
        Kk: function (a) {
            var b = this.dc.clientHeight
                , b = this.dc.scrollTop + b - this.dc.scrollHeight >= .5 * -b || !Ea.Qo(this.dc);
    ...
    mb.prototype = {
        ...
        An: function (a, b) {
            ...
            if (null != c) {
                var d = c[0]
                    , e = new RegExp(D.substr(d, 1, null).split("").map(mb.no).join(".*?"), "i");
                this.Ak = "#" == d.charAt(0);
                this.pi = c.index;
                this.Qq = d.length;
                this.Hl = a;
        ...
        Mj: function (a) {
            if (null != this.Uc) {
                ...
                a = this.Uc[this.wc];
                b != this.wc && (a.Ja.classList.toggle("selected", !0),
                    this.Uc[b].Ja.classList.toggle("selected", !1));
                a = a.Ja;
                b = a.offsetTop;
                a = b + a.offsetHeight;
        ...
        io: function () {
            null != this.Uc && (this.hk(this.Uc[this.wc].item),
                this.Oh())
        },
        f: mb
    };
    ...
    hb.prototype = {
        ...
        C: function (a) {
            var b = a.K;
            null != b && (this.xc.or(60 * a.Da),
                this.xc.nr(b.Hc | 0),
                this.Jb.set(b.Jb),
                this.Pb.set(b.Pb),
                this.Db.Jc(a, this.Nb))
        },
        f: hb
    };
    Sb.b = !0;
    Sb.prototype = {
        ...
        kr: function (a) {
            a != this.dk && (this.Up.className = a ? "overtime on" : "overtime",
                this.dk = a)
        },
        pr: function (a) {
            a != this.ek && (this.g.className = a ? "game-timer-view time-warn" : "game-timer-view",
                this.ek = a)
        },
        f: Sb
    };
    ...
    ja.prototype = {
        C: function (a) {
            ...
            this.Gd ? this.Va.C(a.T, a.T.na(a.uc)) : (a = a.Qf(),
                this.Eb.C(a),
                n.Ma.Tj.Gs(a))
        },
        ke: function (a) {
            this.Gd != a && ((this.Gd = a) ? (this.Hh.appendChild(this.Va.g),
                this.Eb.g.remove()) : (this.Hh.appendChild(this.Eb.g),
                    this.Va.g.remove()))
        },
        Ro: function () {
            return null != ja.bq
        ...
        ab: function (a, b) {
            u.Af(this.gf);
            ja.bq = a;
            null != a ? (this.gf.style.display = "flex",
                this.gf.appendChild(a),
                this.ul = b) : (this.gf.style.display = "none",
                    this.ul = null)
        },
        f: ja
    };
    ...
    ha.prototype = {
        C: function () {
            ...
            !this.Uf || 0 < this.ri.Fd || (this.Uf = !1,
                this.Mp())
        },
        f: ha
    };
    ...
    $a.prototype = {
        Dl: function () {
            var a = this;
            N.pk(n.Gf + "api/notice").then(function (b) {
                var c = b.content;
                null != c && "" != c && $a.Hn != c && (a.Tn.innerHTML = c,
                    a.Tk.hidden = !1,
                    a.nd.onclick = function () {
                        $a.Hn = c;
                        return a.Tk.hidden = !0
                    }
                )
            })
        },
    ...
    Ya.prototype = {
        ...
        C: function (a, b) {
            this.Pq != a.jc && (this.Pq = a.jc,
                this.jc.textContent = a.jc);
            var c = null == b ? !1 : b.bb;
            this.bk != c && (this.g.className = "room-view" + (c ? " admin" : ""),
                this.bk = c);
            var d = !c || null != a.K;
            this.uf.disabled = d;
            this.nf.disabled = d;
    ...
    Ca.Mo = ["click-rail", "drag-thumb", "wheel", "touch"];
    m.Hm = new Map;
    m.wf = 0;
    Ua.za = m.Fa({
        Ba: !1,
    ...
    E.en = .17435839227423353;
    E.dn = 5.934119456780721;
    R.an = new Ib([0, 0, 2, 1, 0, .35, 1, 0, 1, 0, .7, 1, 0, 0, 0, 1]);
    R.bn = new Ib([0, -1, 3, 0, 0, .35, 0, 0, 0, 0, .65, 0, 0, 1, 3, 1]);
